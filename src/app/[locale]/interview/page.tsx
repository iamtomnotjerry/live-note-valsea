...
import { InterviewSessionPanel } from "@/features/interview/interview-session-panel";

export default async function InterviewPage() {
  const t = await getTranslations("InterviewPage");
  const folderResult = await listNoteFolders();
  const folders = folderResult.ok ? folderResult.folders : [];
  ...
  return (
    ...
    >
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:px-6">
        ...
        <InterviewSessionPanel initialFolders={folders} />
      </main>
